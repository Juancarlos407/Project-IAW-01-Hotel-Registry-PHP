...
<head>
                        ...
                        <title>Balearic Hotel Fandos Hotel data policy</title>
</head>
<body>
  ...
  Definitions
  Charity
  means [insert charity name], a registered charity.
  GDPR
  means the General Data Protection Regulation.
  Responsible Person
  means [insert name of person responsible for data protection within the Charity].
  Register of Systems
